    ...
    <div className="hidden lg:flex flex-col justify-between h-full relative overflow-hidden bg-[var(--color-primary)] text-white p-10 rounded-l-2xl">
      ...
      <div className="relative space-y-4">
        <h2 className="text-3xl font-extrabold leading-tight">
          One account.<br />Two identities.
        </h2>
        <p className="text-white/70 text-sm leading-relaxed max-w-xs">
          Build your public developer profile with Nest Feed, then switch to
          Nest Shadow for completely anonymous, bias-free code reviews.
        </p>

        <div className="space-y-3 pt-2">
          {[
            { icon: '🌐', text: 'Share publicly — grow your reputation' },
            { icon: '👤', text: 'Review anonymously — zero bias' },
            { icon: '🤖', text: 'AI tools — smarter every day' },
          ].map((item) => (
          ...
          <div className="bg-[var(--bg-surface)] flex flex-col justify-center px-8 py-10 space-y-6 rounded-r-2xl rounded-l-2xl lg:rounded-l-none">
            <div className="space-y-1">
              ...
              <div className="flex items-center gap-2 mb-4 lg:hidden">
                <div className="w-8 h-8 rounded-xl bg-[var(--color-primary)] flex items-center justify-center font-bold text-white text-sm">
                  CN
                </div>
                <span className="text-base font-bold text-[var(--text-main)]">CodeNest</span>
              </div>
              <h1 className="text-2xl font-extrabold text-[var(--text-main)]">Welcome back</h1>
              <p className="text-sm text-[var(--text-muted)]">Sign in to your developer account</p>
            </div>
